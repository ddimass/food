...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php echo $form->errorSummary(ProductIngred::model()); ?>

	<div class="row">
		<?php // echo $form->labelEx($model,'tbl_product_id'); ?>
		<?php echo $form->textField(ProductIngred::model(),'tbl_product_id', array('style'=>'display:none;','value'=>$pid)); ?>
		<?php echo $form->dropDownList(ProductIngred::model(),'tbl_ingred_id',CHtml::listData(Ingred::model()->findall(),'id','name'),array('style'=>'display:none;')); ?>
		<?php echo $form->textField(ProductIngred::model(),'count',array('style'=>'display:none;','value'=>12345678)); ?>
	...
	<div style="float:left; width:45%;padding: 3px;">
		<?php echo $form->labelEx(ProductIngred::model(),'tbl_ingred_id'); ?>
	</div>
	<div style="float:right; width:45%;">
		<?php echo $form->labelEx(ProductIngred::model(),'count'); ?>
	</div>
	<?php for ($i = 0;$i<=10;$i++) {
