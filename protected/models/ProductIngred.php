...
/**
 * This is the model class for table "tbl_product_ingred".
 *
 * The followings are the available columns in table 'tbl_product_ingred':
 * @property integer $id
 ...
 */
class ProductIngred extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('tbl_product_id, count, tbl_ingred_id', 'required'),
			array('tbl_product_id, tbl_ingred_id', 'numerical', 'integerOnly'=>true),
			array('count', 'numerical', 'integerOnly'=>false),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, tbl_product_id, count, tbl_ingred_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return ProductIngred the static model class
	 */
