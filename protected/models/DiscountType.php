 ...
 *
 * The followings are the available columns in table 'tbl_discount_type':
 * @property integer $id
...
class DiscountType extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, type, date, description, value', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'tblClients' => array(self::HAS_MANY, 'TblClients', 'tbl_discount_type_id'),
		);
	}
